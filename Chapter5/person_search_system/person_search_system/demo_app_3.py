...
class DemoApp(QWidget):
    def __init__(self):
        ...
        self.tabs.addTab(self.detection_tab, "行人追踪")
    ...
    def init_search_tab(self):
        # 行人搜索 Tab 布局
        layout = QVBoxLayout()
        layout.setSpacing(0)  # 控件间距设置为 0
        layout.setContentsMargins(5, 5, 5, 5)  # 设置布局外边距

        # 显示查询图片
        self.query_img_label = QLabel("要查询的目标任务")
...
# ------------------------------------------------------------------------检测
    ...
    def init_detection_tab(self):
        ...
        # 模型选择标签和下拉框
        self.model_label = QLabel("选择追踪模型")
        ...
        # 带检测框的视频显示区域
        self.detected_video_label = QLabel("追踪视频")
